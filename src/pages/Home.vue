...
<template>
    <section class="grid grid-rows-12 grid-cols-1 h-screen">
        ...
        <div class="flex flex-col max-w-4xl w-full gap-12 p-12 justify-self-center row-span-11">
            <h1 class="text-dark text-4xl font-semibold">Bienvenido/a, {{ userStore.user.name }}</h1>
            ...
            <div class="flex flex-col p-6 gap-4 shadow rounded bg-background">
                <h2 class="text-dark text-3xl">Tus últimos artículos</h2>
                <div
